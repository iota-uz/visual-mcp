  ...
  try {
    ...
    if (body.operation === "video") {
      ...
      > = {
        ...
        characterActionRegister: { method: "characterLibrary:agentRegister", kind: "mutation" },
        characterActionPromote: { method: "characterLibrary:agentPromote", kind: "mutation" },
        characterActionGet: { method: "characterLibrary:agentGet", kind: "query" },
        characterActionList: { method: "characterLibrary:agentList", kind: "query" },
