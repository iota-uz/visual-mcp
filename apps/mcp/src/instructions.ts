...
export function buildInstructions(): string {
  return [
    ...
    "",
    "DELIVERY. Use returned canvas_url/present_url/share_url; never construct them. Use canvas_embed for canvas.iota.uz PNG Markdown in trackers; it exposes published content only and updates after publish unless explicitly pinned. Hand the user share_url only when public sharing was requested. Read canvas://guides/authoring, production-ui, device-frames, assets, or embeds when relevant.",
  ].join("\n");
}
